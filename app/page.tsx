        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
            {instructors.map((instructor) => (
              <article
                key={instructor.name}
                className="flex h-full flex-col rounded-3xl border border-cyan-300/20 bg-gradient-to-br from-violet-950/70 via-slate-950/90 to-cyan-950/30 p-5 shadow-[0_0_35px_rgba(103,232,249,0.14)]"
              >
                <div className="relative mb-5 h-[320px] w-full overflow-hidden rounded-2xl border border-fuchsia-400/30 bg-black/40">
                  <img
                ...
                <div className="flex flex-1 flex-col">
                  ...
                  <p className="mt-2 text-sm font-bold leading-snug text-cyan-200">
                    {instructor.role}
                  </p>
